...
var addTwoNumbers = function(l1, l2) {
    ...
    let l3 = (parseInt(l1.reverse().join('')) + parseInt(l2.reverse().join(''))).toString().split('');

    return l3.reverse().map(Number);
};

console.log(addTwoNumbers([2,4,3], [5,6,4])); //Output: [7,0,8] Explanation: 342 + 465 = 807.
